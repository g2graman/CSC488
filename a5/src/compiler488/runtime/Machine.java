...
public final class Machine
    ...
    /** power status flag used to check for misuse of machine 
     *  set to false by powerOn, set to true at end of execution 
     *  checked on access to the machine
     */
    private static boolean  powerIsOff  = true ;
	...
	startMSP = - 1 ;
        startMLP = - 1 ;
        // Mark that machine has been initialized
        powerIsOff = false ;
    }

    /** Finailze the machine after execution.
     *  Set powerIsOff to true
     */
    private final static void powerOff() {
         powerIsOff = true ;
    }

    /** Check that machine has been initialized before use
     *  @throws  ExecutionException   machine not initialized
     */
    private final static void checkPowerStatus()
         throws ExecutionException
    {
         if( powerIsOff ) 
            throw new ExecutionException( "Attempt to use uninitialized machine" );
    }
     ...
     *  @throws MemoryAddressException  address out of memory
     *  @throws  ExecutionException      machine not initialized
     */
    ...
    public final static short readMemory( short addr )
      ...
      * start of execution.
      * @param  addr  memory address for intial value of program counter
      */
      ...
      * <B>Policy:</B> do not check addr for validity, error will be caught at
      * start of execution.
      * @param  addr   memory address for start of runtime stack
      */
      ...
      * <B>Policy:</B> do not check addr for validity, error will be caught at
      * start of execution.
      *  @param addr  memory address for top of run time stack
      */
     ...
     *  @throws ExecutionException  from formatInstruction
     */
     ...
     *  @throws ExecutionException    propagate error message outward.
     */
     ...
     * @throws  ExecutionException  invalid/missing instruction length
     */
     ...
     *  This function checks that lowBound &lt;= value &lt;= highBound
     ...
     *  @throws ExecutionException   from runError
     */
     ...
     *  @throws ExecutionException  error during instruction execution
     */
	...
	while (executing)
		...
		*/
		...
		case BR:
            //System.out.println("PC "+pc);
            //System.out.println("PC2 "+memory[msp-1]);
